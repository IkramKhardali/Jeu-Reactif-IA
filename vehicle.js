/*
  ...
  */
  ...
  // Set stroke properties for wireframe
  stroke(255);
  strokeWeight(2);

  // Set fill color for the car body
  fill(0);

  // Translate to the vehicle's position
  ...
  // Circle for avoidance between vehicles and obstacles
  if (Vehicle.debug) {
    stroke(255);
    noFill();
